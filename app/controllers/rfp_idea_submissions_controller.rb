class RfpIdeaSubmissionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if verify_recaptcha(model: @rfp_idea_submission) && @rfp_idea_submission.save
        ...
        flash[:alert] = "Error submitting idea. Please complete all required fields and verify the CAPTCHA."
