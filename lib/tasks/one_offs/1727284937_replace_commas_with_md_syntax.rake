namespace :one_offs do
  ...
  task oneoff_update_markdown_format: :environment do
    ...
    Enrollment.find_each do |enrollment|
      if enrollment.skills_development.present? && !enrollment.skills_development.strip.start_with?("-")
